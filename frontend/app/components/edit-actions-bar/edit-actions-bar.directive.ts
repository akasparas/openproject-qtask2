...
import {wpDirectivesModule} from "core-components/../angular-modules";
import {WorkPackageEditFieldGroupController} from 'core-components/wp-edit/wp-edit-field/wp-edit-field-group.directive';

export class EditActionsBarrController {
...
function editActionsBarr() {
  return {
    ...
    controller: EditActionsBarrController,
    controllerAs: '$ctrl'
  };
}

angular.module('openproject').directive('editActionsBarr', editActionsBarr);
